  ...
  return (
    <>
      <header className="rounded-[28px] border border-white/60 bg-white/70 px-6 py-5 shadow-[0_30px_80px_-40px_rgba(34,21,6,0.35)] backdrop-blur">
        <p className="text-xs font-semibold uppercase tracking-[0.25em] text-[#8d5a2b]">Mobile</p>
        <h1 className="mt-2 text-2xl font-semibold">Mobile experience workspace</h1>
        <p className="mt-1 text-sm text-[#6a5f54]">UI-only scaffold for mobile page management.</p>
      </header>
      ...
      <section className="grid gap-6 lg:grid-cols-[280px_1fr]">
        <aside className="rounded-[28px] border border-white/60 bg-white/70 p-5 shadow-[0_30px_80px_-40px_rgba(34,21,6,0.35)] backdrop-blur">
          <h2 className="text-sm font-semibold uppercase tracking-[0.14em] text-[#8d5a2b]">Mobile pages</h2>
        ...
        <div className="rounded-[28px] border border-white/60 bg-white/70 p-6 shadow-[0_30px_80px_-40px_rgba(34,21,6,0.35)] backdrop-blur">
          <h2 className="text-lg font-semibold">Page preview panel</h2>
            ...
            {mobilePages.map((item) => (
              ...
              >
                ...
                <p className="mt-2 text-xs text-[#6a5f54]">
                  Placeholder card. Replace with your real mobile page modules.
                </p>
              </div>
            ))}
          </div>
